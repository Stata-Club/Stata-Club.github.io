...
"use strict";
function i(e,i){
o("http://mp.weixin.qq.com/mp/ad_report?action=follow&type="+e+i);
}
function t(e){
var t=e.url||"";
t=t.replace(/&amp;/g,"&");
...
function a(e){
n.isIOS&&n.gtVersion("6.5.22",!0)&&r.invoke("preloadMiniProgramContacts",{
userNames:[e.weapp_info.original_id+"@app"]
},function(){});
}
var r=e("biz_wap/jsapi/core.js"),o=e("biz_common/utils/report.js"),n=e("biz_wap/utils/mmversion.js");
return{
openWxopen:t,
startConnect:a
};
