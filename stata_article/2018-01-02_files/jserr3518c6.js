...
var o=n.children[a];
o.className.indexOf("img_loading")>=0&&o.getAttribute("data-vid")==r&&i.push(o);
}
...
var o=r[a];
if(2==o.type){
if(2==n&&i==o.source_uin)continue;
t[o.img_url]={
...
for(var d=document.getElementsByTagName("img"),a=0,s=d.length;s>a;a++){
var o=d[a],_=o.getAttribute("data-src")||o.getAttribute("data-backsrc")||"";
if(t[_]){
var m=document.createElement("div");
m.innerHTML=x.tmpl(u,t[_]);
{
var c=m.children[0],p=o.parentNode,l=p.insertBefore(c,o),w=l.children[0];
(function(e,t){
...
function s(e){
if(O&&O.length>0)for(var t,r,n,i=0,a=O.length;a>i;++i)t=O[i],r=t.iframe,n=t.src,
...
r.liked&&j.addClass(t,"praised"),t.setAttribute("like",r.liked?"1":"0");
...
-1==y.indexOf("WindowsWechat")&&-1!=y.indexOf("MicroMessenger")&&(c=e("appmsg/reward_entry.js"),
...
var r=B.checkNeedAds(),n=r.is_need_ad,i=(r._adInfo,r.both_ad),d=-1!=location.href.indexOf("mock_ad=");
d&&(r.is_need_ad=n=1),z("[Appmsg] start get asycn data, is_need_ad:"+n);
...
B.afterGetAdData(r,t),window.wx_user_can_reward=t.user_can_reward,o({
...
e("biz_common/utils/string/html.js");
var c,p,l=e("pages/video_ctrl.js"),w=e("biz_common/utils/url/parse.js"),g=e("biz_common/dom/class.js"),u=e("appmsg/img_copyright_tpl.html.js"),h=e("appmsg/share_tpl.html.js"),y=navigator.userAgent,f=-1!=y.indexOf("MicroMessenger"),v=(-1!=navigator.userAgent.indexOf("WindowsWechat"),
